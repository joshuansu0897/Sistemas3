...
public class Server2 extends javax.swing.JFrame {
    ...
    public Server2() {
        initComponents();
        try {
            System.out.println("Server 2 port 3000");
                ...
                public void run() {
                    try {
                        while (true) {
                            ...
                            DOSs.put(uuid, dos);
                            sendMessage("Cliente nuevo con username " + uuid, null);
    ...
    private void sendMessage(String str, String uuidSender) {
        ...
        if (message.equals("1")) {
            message = getImpar1al100();
        } else if (message.equals("2")) {
            message = getPar1al100();
        } else {
            message = "nada mas 1 o 2";
        }
